...
from ksfdtw.utils import precision_at_k, nearest_neighbor_search_lb3
...
function_map = {
    "usdtw_prime": usdtw_prime,
    "psdtw_prime_vanilla": psdtw_prime_vanilla,
    "psdtw_prime_parallel": psdtw_prime_parallel,
    "psdtw_prime_parallel_bsf": psdtw_prime_parallel_bsf,
    "psdtw_prime_parallel_bsf_lb": psdtw_prime_parallel_bsf_lb,
    "psdtw_prime_parallel_bsf_lb2": psdtw_prime_parallel_bsf_lb2,
    "psdtw_prime_parallel_bsf_lb3": psdtw_prime_parallel_bsf_lb3,
    "cut_based_distance": cut_based_distance,
}

parser = argparse.ArgumentParser()
parser.add_argument("--P", type=int, default=3, help="Scaling factor P")
parser.add_argument("--l", type=float, default=1.50, help="Constraint parameter l")
parser.add_argument("--function_used", type=str, default="psdtw_prime_parallel_bsf", help="Function name to use")
parser.add_argument("--dist_method", type=int, default=0, help="Distance method (0 for ED, 1 for DTW)")

args = parser.parse_args()
P = args.P
l = args.l
function_used_name = args.function_used
...
# %%
# dist_method is already parsed from args
r = 0.0
if dist_method == 1:
    r = 0.1
function_used = function_map[function_used_name]

# %%
# Warmup for numba
start = time.time()
nearest_neighbor_search_lb3(query_set[0][:-1], target_set[:, :-1], r=r, l=l,  P=P, dist_method=dist_method, dist_func=function_used)
end = time.time()
elapsed_time = end - start
# print(elapsed_time)
